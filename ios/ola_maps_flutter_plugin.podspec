...
# Run `pod lib lint ola_maps_flutter_plugin.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'ola_maps_flutter_plugin'
  s.version          = '0.0.1'
...
#    s.vendored_frameworks = 'xxxxxx.xcframework'
  ...
  # s.resource_bundles = {'ola_maps_flutter_plugin_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
